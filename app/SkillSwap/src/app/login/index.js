...
const Login = () => {
  ...
  const containerStyle = darkmode? loginstyle.containerdark: loginstyle.container;
...
const cajatextoData = darkmode? fondo.cajatextodark:fondo.cajatexto;
 ...
 <StatusBar backgroundColor={darkmode ? '#000' : '#000'} />
      <View
        style={{
          width: "100%",
      ...
      <View style={{ height: "50%" , flexDirection:"column" ,gap:30,alignItems:"center",marginVertical:50 }}>
     

        <TextInput style={cajatextoData} value="" ></TextInput>
        <TextInput style={cajatextoData} value="" ></TextInput>
        <TextInput style={cajatextoData} value="" ></TextInput>
        <TouchableOpacity onPress={() => redireccionar()} style={comunButton.boton}>
          <Text style={titulodarkdata}>iniciar</Text>
        </TouchableOpacity>
